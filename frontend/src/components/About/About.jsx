...
import portrait from "../../assets/Professional-Pic.jpeg";

function About() {
  const timeline = [
    {
      name: "Life-Changing Decision",
      description: "Made a life-changing decision to pursue a career change and improve my life.",
      date: "June 2021",
      dateTime: "2021-06",
    },
    {
      ...
      description:
        "Started working as a freelancer, building websites for clients and gaining practical experience.",
      date: "May 2022",
      dateTime: "2022-05",
    },
    {
      name: "Started Year-Long Bootcamp",
      description:
        "Attended a year-long bootcamp to deepen my skills and broaden my knowledge in coding.",
      date: "Nov 2022",
      dateTime: "2022-11",
    },
    {
      name: "Secured First Full Stack Developer Job",
      description:
        "Successfully landed my first job as a full stack developer, applying the skills learned during my journey.",
      date: "Nov 2023",
      dateTime: "2023-11",
    },
  ];
  ...
  //       {
  //         name: "X",
  //         href: "https://twitter.com/al_the_coder",
  //         icon: (props) => (
            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              ...
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                <p className="text-xl leading-8 text-gray-600 font-coolthin">
                  ...
                  exploring the frontiers of innovation. Join me on this adventure, where I'll be
                  sharing insights, challenges, and victories, all while shaping the future of my
                  tech-infused passions.
                </p>
              </div>
              <img
                src={portrait}
...
//             <item.icon className="h-6 w-6 cursor-pointer" aria-hidden="true" />
//           </a>
//         ))}
//       </div>
//       <p className="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">
//         &copy; {year} Albert Marrero. All rights reserved.
//       </p>
//     </div>
//   </div>
// </footer>
